 ...
 * these slot counts (`src/contracts/capability-plan.ts`). NIC slots
 ...
 * (`src/features/tiers/assignment.ts`), and the placement bands. It is copied
...
import type { MetricsCapabilityTierEntitlements } from '../../contracts/capability-plan.ts'

 ...
 *
 * Regenerate with:
 *   deno eval "import { DOCKER_RUN_OPTIONS } from '../../lib/docker-run/src/features/docker-run/option-registry.ts'; \
 *     console.log(JSON.stringify({ options: DOCKER_RUN_OPTIONS.map((d) => ({ names: [...d.names], behavior: d.behavior })) }, null, 2))" \
 *     > src/features/docker-run/option-registry.fixture.json
 */

 ...
 * appear nowhere under `src/features/billing/`.
 */
...
test('the raw anchor timestamp, the proration-disabling value, and schedule `iterations` appear nowhere under src/features/billing/', async () => {

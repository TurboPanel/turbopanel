...
import { encodeCommandEnvelope, parseCommandEnvelope } from "../../features/commands/envelope.ts";
import {
...
import { COMMAND_TYPES, type CommandType } from "../../features/commands/types.ts";
...
/** Keep byte-identical order with daemon `src/contracts/commands-contracts.ts`. */

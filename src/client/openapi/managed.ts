...
export const managedSchemas = {
  ...
  ManagedReplicaNotPromotableError: errorSchema(
...
export const managedPaths = {
  "/api/client/v1/environments/{id}/managed": {
    ...
    post: {
      ...
      responses: {
        ...
        409: {
          description:
            "server_placement_required / server_offline / managed_busy",
          content: {
            "application/json": {
              schema: {
                oneOf: [
  ...
  "/api/client/v1/environments/{id}/managed/backups/{backupId}": {
    delete: {
      tags: ["Managed services"],
      summary:
        "Delete a backup artifact: enqueue managed.backup (action=delete)",
      description:
        "The row is removed from the `backup` table by the consumer on success.",
            ...
            "application/json": {
              schema: {
                oneOf: [
                  {
                    $ref:
                      "#/components/schemas/FailoverReplicaRequiresDatacenterTransportError",
                  },
            ...
            "application/json": {
              schema: {
                oneOf: [
                  {
                    $ref:
                      "#/components/schemas/ManagedReplicaNotStreamingError",
                  },

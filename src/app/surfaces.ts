 ...
 * `webhookPathFor` in `src/features/git/webhook-reachability.ts`.
 */
 ...
 * instead of an HMAC over the body (`src/features/git/gitlab-webhook.ts`).
 */
 ...
 * inherits the plumbing — and `src/app/surfaces.test.ts` checks that rather than
